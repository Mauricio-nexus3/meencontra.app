              ...
              leading: Builder(
                builder: (context) => FlutterFlowIconButton(
                  ...
                  onPressed: () async {
                    ...
                    // Verificar se tem imagem carregada. URL.
                    if (_model.uploadedFileUrl != null &&
                        _model.uploadedFileUrl != '') {
                      // Se ela estiver carregada, apagar primeiro ela da storage
                      await showDialog(
                        context: context,
                            ...
                            child: WebViewAware(
                              child: GestureDetector(
                                ...
                                child: AlertConfirmPopUpWidget(
                                  tituloAcao: 'Descartar alterações',
                                  textoAcao:
                                      'descartar as alterações feitas até agora',
                                  tipoAlerta: TipoAlerta.alerta.name,
                                  tituloBotao: 'Sim, Descartar',
                                  acao: () async {
                                    context.safePop();
                                  },
                                ),
