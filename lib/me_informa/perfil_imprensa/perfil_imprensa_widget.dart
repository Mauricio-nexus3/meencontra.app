...
import 'perfil_imprensa_model.dart';
export 'perfil_imprensa_model.dart';

class PerfilImprensaWidget extends StatefulWidget {
  const PerfilImprensaWidget({
    super.key,
  ...
  @override
  State<PerfilImprensaWidget> createState() => _PerfilImprensaWidgetState();
}

class _PerfilImprensaWidgetState extends State<PerfilImprensaWidget>
    with TickerProviderStateMixin {
  late PerfilImprensaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PerfilImprensaModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PerfilImprensa'});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<MateriasRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MateriasRecord> perfilImprensaMateriasRecordList = snapshot.data!;

        return Title(
            title: 'PerfilImprensa',
              ...
              child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  leading: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'PERFIL_IMPRENSA_arrow_back_ios_rounded_I');
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    perfilImprensaMateriasRecordList.length
                                        .toString(),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'PERFIL_IMPRENSA_NOVA_MATERIA_BTN_ON_TAP');
                                          ...
                                          child: TabBar(
                                            ...
                                            onTap: (i) async {
                                              [
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_PAGE_Tab_politica_ON_TAP');
                                                ...
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_PAGE_Tab_saude_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Saúde';
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_Tab_seguranca_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Segurança';
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_PAGE_Tab_esporte_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Politica';
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_PAGE_Tab_cidade_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Cidades';
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_PAGE_Tab_eventos_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Esporte';
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_Tab_cominudade_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Comunidade';
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_PAGE_Tab_economia_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Economia';
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_PAGE_Tab_educacao_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Educação';
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_Tab_transporte_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Transporte';
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_Tab_arte-cultura_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Arte/Cultura';
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_Tab_internacional_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Internacional';
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_Tab_meioAmbiente_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Meio Ambiente';
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_PAGE_Tab_tempo_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Tempo';
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'PERFIL_IMPRENSA_PAGE_Tab_x6b8w8rm_ON_TAP');
                                                  _model.categoriaMateria =
                                                      'Eventos';
                                                  safeSetState(() {});
                                                }
                                      ...
                                      if (_model.tabBarCurrentIndex
                                        ...
                                        return wrapWithModel(
                                          ...
                                          child: CardPerfilTVGOoficialWidget(
                                            numeroMaterias:
                                                perfilImprensaMateriasRecordList
                                                    .where((e) =>
                                                        e.categoria ==
                                                        'Politica')
                                                    .toList()
                                                                    ...
                                                                    children: [
                                                                      Builder(
                                                                        builder:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('PERFIL_IMPRENSA_more_vert_ICN_ON_TAP');
                                                                            await showDialog(
                                                                              context: context,
