...
class MateriaWidget extends StatefulWidget {
  ...
  @override
  State<MateriaWidget> createState() => _MateriaWidgetState();
}

class _MateriaWidgetState extends State<MateriaWidget>
    with TickerProviderStateMixin {
  late MateriaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MateriaModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Materia'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('MATERIA_PAGE_Materia_ON_INIT_STATE');
      _model.tabBarb = 0;
      safeSetState(() {});
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('MATERIA_arrow_back_ios_rounded_ICN_ON_TA');
                  context.pop();
                },
              ),
              title: Text(
                                          ...
                                          child: TabBar(
                                            ...
                                            onTap: (i) async {
                                              [
                                                () async {
                                                  logFirebaseEvent(
                                                      'MATERIA_PAGE_url_image_ON_TAP');
                                                  _model.tabBarb = 0;
                                                  safeSetState(() {});
                                                },
                                                () async {
                                                  logFirebaseEvent(
                                                      'MATERIA_PAGE_upload_image_ON_TAP');
                                                  _model.tabBarb = 1;
                                                  safeSetState(() {});
                                                }
                                              ][i]();
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'MATERIA_PAGE_PUBLICAR_MATRIA_BTN_ON_TAP');
                                      ...
                                      await materiasRecordReference.set({
                                        ...createMateriasRecordData(
                                          ...
                                          materiaDestaque: _model.destaqueValue,
                                          ...
                                          descricaoImg: _model
                                              .descricaoFotoTextController.text,
                                      ...
                                      _model.materiaRef =
                                          MateriasRecord.getDocumentFromData({
                                        ...createMateriasRecordData(
                                          creditosImagem: _model
                                              .creditosImgTextController.text,
                                          escritoPor: _model
