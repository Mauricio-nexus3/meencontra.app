...
class FeedModel extends FlutterFlowModel<FeedWidget> {
  ...
  // Model for headerTitleFeed component.
  late HeaderTitleFeedModel headerTitleFeedModel3;
  // State field(s) for desktop widget.
  ...
  // Model for headerTitleFeed component.
  late HeaderTitleFeedModel headerTitleFeedModel4;
  ...
  void initState(BuildContext context) {
    ...
    headerTitleFeedModel3 = createModel(context, () => HeaderTitleFeedModel());
    feedCompletoDivirtaModel =
        createModel(context, () => FeedCompletoDivirtaModel());
    headerTitleFeedModel4 = createModel(context, () => HeaderTitleFeedModel());
  }
  ...
  void dispose() {
    ...
    headerTitleFeedModel3.dispose();
    feedCompletoDivirtaModel.dispose();
    headerTitleFeedModel4.dispose();
