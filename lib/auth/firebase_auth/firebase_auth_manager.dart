    ...
    try {
      ...
      if (e.code == 'requires-recent-login') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Tempo decorrido desde o último login é muito longo. Faça login novamente antes de excluir sua conta')),
        );
      }
    }
  }
    ...
    try {
      ...
      if (e.code == 'requires-recent-login') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Tempo decorrido desde o último login é muito longo. Faça login novamente antes de atualizar seu e-mail.')),
        );
      }
    }
  }
  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      return userCredential == null
          ? null
          : MeencontraFirebaseUser.fromUserCredential(userCredential);
    } on FirebaseAuthException catch (e) {
