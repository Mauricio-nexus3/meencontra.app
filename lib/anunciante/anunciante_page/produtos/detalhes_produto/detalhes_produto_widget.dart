...
import '/anunciante/carrinho_compras/popup_esvaziar_carrinho/popup_esvaziar_carrinho_widget.dart';
...
class DetalhesProdutoWidget extends StatefulWidget {
  ...
  final List<ProdutoRecord>? moreProdutos;
...
class _DetalhesProdutoWidgetState extends State<DetalhesProdutoWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'DetalhesProduto'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('DETALHES_PRODUTO_DetalhesProduto_ON_INIT');
      ...
      setState(() {
        _model.addToImagensList(widget.detalhesProduto!.fotoProduto);
      });
      setState(() {
        _model.addToImagensList('');
      });
    });
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'DETALHES_PRODUTO_arrowBack_ICN_ON_TAP');
                            ...
                            if (widget.anunciante?.temCarrinho == true)
                              Builder(
                                builder: (context) => InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'DETALHES_PRODUTO_Badge_5prbuo5f_ON_TAP');
                                    if (loggedIn == true) {
                                      await showDialog(
                                        context: context,
                                  ...
                                  child: badges.Badge(
                                    ...
                                    child: Builder(
                                      builder: (context) =>
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'DETALHES_PRODUTO_shopping_cart_outlined_');
                                          if (loggedIn == true) {
                                            await showDialog(
                                              context: context,
                                              builder: (dialogContext) {
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'DETALHES_PRODUTO_chevron_left_sharp_ICN_');
                                      ...
                                      if (widget.anunciante?.temCarrinho ==
                                          true)
                                        Builder(
                                          builder: (context) => InkWell(
                                            splashColor: Colors.transparent,
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'DETALHES_PRODUTO_Badge_voaehhwl_ON_TAP');
                                              if (loggedIn == true) {
                                                await showDialog(
                                                  context: context,
                                                  builder: (dialogContext) {
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'DETALHES_PRODUTO_Text_dl6d8b9g_ON_TAP');
                                        setState(() {
                                          FFAppState()
                                    ...
                                    children: [
                                      Builder(
                                        builder: (context) => FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'DETALHES_PRODUTO_realizarPedido_ON_TAP');
                                            if (FFAppState()
                                                    .qntdItensCarrinho >=
                                                1) {
                                              await showDialog(
                                            ...
                                            if ((detalhesProdutoCarrinhoDeComprasUsuarioRecordList
                                              ...
                                              return Builder(
                                                builder: (context) =>
                                                  ...
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'DETALHES_PRODUTO_carrinhoCheioItensOutro');
                                                    await showDialog(
                                                      context: context,
                                                      builder: (dialogContext) {
                                                        return Dialog(
                                              ...
                                              return Builder(
                                                builder: (context) =>
                                                  ...
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'DETALHES_PRODUTO_carrinhoCheio_ON_TAP');
                                                    await showDialog(
                                                      context: context,
                                                      builder: (dialogContext) {
                                                        return Dialog(
                                              ...
                                              return Visibility(
                                                ...
                                                child: Builder(
                                                  builder: (context) =>
                                                    ...
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'DETALHES_PRODUTO_PAGE_addCarrinho_ON_TAP');
                                                      if (loggedIn == true) {
                                                        if (FFAppState()
                                                                .qntdItensCarrinho >=
                                                            1) {
                                                          if (FFAppState()
                                                            ...
                                                            setState(() {
                                                              FFAppState().addToNomesProdutosCarrinhoUsuer(widget
                                                                  .detalhesProduto!
                                                                  .nomeProduto);
                                                              FFAppState()
                                                                      .qntdItensCarrinho =
                                                                  ...
                                                                  await showDialog<
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return WebViewAware(
                                                                            child:
                                                                                AlertDialog(
                                                                              title: Text('Carrinho quase cheio'),
                                                                              content: Text('Você já possui 3 itens no seu carrinho do limite de 5'),
                                                                              actions: [
                                                                                TextButton(
                                                                                  onPressed: () => Navigator.pop(alertDialogContext, false),
                                                                                  child: Text('Continuar comprando'),
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'DETALHES_PRODUTO_Text_jasvdcmp_ON_TAP');
                                ...
                                Container(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      final seeMore = widget.moreProdutos!
                                          .where((e) =>
                                              e.nomeProduto !=
                                              widget
                                      ...
                                      return ListView.separated(
                                        ...
                                        separatorBuilder: (_, __) =>
                                            SizedBox(width: 12.0),
                                        itemBuilder: (context, seeMoreIndex) {
                                          final seeMoreItem =
                                              seeMore[seeMoreIndex];
                                          return InkWell(
                                            splashColor: Colors.transparent,
                                            focusColor: Colors.transparent,
                                            hoverColor: Colors.transparent,
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'DETALHES_PRODUTO_Container_kplpyema_ON_T');
                                            ...
                                            child: GridProdutoWidget(
                                              key: Key(
                                                  'Keykpl_${seeMoreIndex}_of_${seeMore.length}'),
                                              titulo: seeMoreItem.nomeProduto,
                                              valor: seeMoreItem.valorVenda,
                                              img: seeMoreItem
