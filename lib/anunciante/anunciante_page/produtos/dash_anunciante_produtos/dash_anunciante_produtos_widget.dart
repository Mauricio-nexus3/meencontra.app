...
import 'dash_anunciante_produtos_model.dart';
export 'dash_anunciante_produtos_model.dart';

class DashAnuncianteProdutosWidget extends StatefulWidget {
  const DashAnuncianteProdutosWidget({
    super.key,
    this.anuncianteDoc,
  });
  ...
  @override
  State<DashAnuncianteProdutosWidget> createState() =>
      _DashAnuncianteProdutosWidgetState();
}

class _DashAnuncianteProdutosWidgetState
    extends State<DashAnuncianteProdutosWidget> with TickerProviderStateMixin {
  late DashAnuncianteProdutosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashAnuncianteProdutosModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'DashAnuncianteProdutos'});
                                  ...
                                  child: Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'DASH_ANUNCIANTE_PRODUTOS_Icon_6gorqqr8_O');
                                        ...
                                        children: [
                                          Builder(
                                            builder: (context) =>
                                              ...
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'DASH_ANUNCIANTE_PRODUTOS_PRODUTO_BTN_ON_');
                                                await showDialog(
                                                  barrierColor:
                                                      FlutterFlowTheme.of(
                                                              context)
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Flexible(
                                      child: Text(
                                        'Agora você pode escolher até 5 itens deixar em destaque. ',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Inter',
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            Flexible(
                                                                              child: Container(
                                                                                ...
                                                                                child: Builder(
                                                                                  builder: (context) {
                                                                                    final img = listViewProdutoRecord.imagensProduto.toList().take(1).toList();
                                                                                    return Row(
                                                                                      mainAxisSize: MainAxisSize.max,
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              value: listViewProdutoRecord.ativo,
                                                                              onIcon: Icon(
                                                                                Icons.check_box,
                                                                                color: valueOrDefault<Color>(
                                                                        ...
                                                                        children: [
                                                                          Builder(
                                                                            builder: (context) =>
                                                                              ...
                                                                              onPressed: () async {
                                                                                logFirebaseEvent('DASH_ANUNCIANTE_PRODUTOS_more_vert_ICN_O');
                                                                                await showDialog(
                                                                                  context: context,
                                                                                  builder: (dialogContext) {
                                                                                    return Dialog(
                                                                                                    ...
                                                                                                    child: WebViewAware(
                                                                                                      child: GestureDetector(
                                                                                                        ...
                                                                                                        child: CadastrarProdutoWidget(
                                                                                                          ...
                                                                                                          edicao: true,
                                                                                                          valorParaEdicao: listViewProdutoRecord.valorVenda,
                                                                                                        ),
                                                                                                      ),
                                                                                                    ),
                                                                                                  );
