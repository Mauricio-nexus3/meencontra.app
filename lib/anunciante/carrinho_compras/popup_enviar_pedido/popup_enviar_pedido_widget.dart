                                  ...
                                  children: [
                                                            ...
                                                            children: [
                                                              InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'POPUP_ENVIAR_PEDIDO_Row_15ewq0kw_ON_TAP');
                                                                  if (containerVarItem
                                                                          .quantidadeProduto <=
                                                                      1) {
                                                              ...
                                                              InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'POPUP_ENVIAR_PEDIDO_Icon_forurk5l_ON_TAP');
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'POPUP_ENVIAR_PEDIDO_ENVIAR_PEDIDO_BTN_ON');
                                          ...
                                          await launchURL(
                                              '${'https://wa.me/55${widget.anunciante?.whatsComercial}&text='}${'${functions.formatarParaWhatsApp('Olá meu nome é ')}${functions.formatarParaWhatsApp(currentUserDisplayName)}${functions.formatarParaWhatsApp('.  vim através do meencontra.app e adicionei ao meu carrinho os seguintes itens:')}'}${'${functions.formatarParaWhatsApp(_model.novoPedidoWhatsappAnunciante!.pedido)}${'${functions.formatarParaWhatsApp(', Obs:')}${functions.formatarParaWhatsApp(_model.novoPedidoWhatsappAnunciante!.observacaoPedido)}'}'}');
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'POPUP_ENVIAR_PEDIDO_CANCELAR_BTN_ON_TAP');
                                        Navigator.pop(context);
                                      },
                                      text: 'Cancelar',
                                      options: FFButtonOptions(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'POPUP_ENVIAR_PEDIDO_CHAMAR_NO_WHATSAPP_B');
                                            await showDialog(
                                              context: context,
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'POPUP_ENVIAR_PEDIDO_VOLTAR_PARA_OS_ITENS');
                                          setState(() {
                                            FFAppState().qntdItensCarrinho = 0;
                                            FFAppState()
                                                .nomesProdutosCarrinhoUsuer = [];
