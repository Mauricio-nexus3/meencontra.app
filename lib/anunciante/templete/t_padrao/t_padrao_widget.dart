...
import 't_padrao_model.dart';
export 't_padrao_model.dart';

class TPadraoWidget extends StatefulWidget {
  const TPadraoWidget({
    super.key,
    required this.doc,
  });
  ...
  @override
  State<TPadraoWidget> createState() => _TPadraoWidgetState();
}

class _TPadraoWidgetState extends State<TPadraoWidget>
    with TickerProviderStateMixin {
  late TPadraoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TPadraoModel());
                  ...
                  Row(
                    ...
                    children: [
                      Flexible(
                        child: Container(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'T_PADRAO_COMP_Row_jsjl9rto_ON_TAP');
                      ...
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent('T_PADRAO_COMP_call_ICN_ON_TAP');
                        ...
                        Column(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'T_PADRAO_COMP_instagram_ICN_ON_TAP');
                        ...
                        Column(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'T_PADRAO_COMP_facebook_ICN_ON_TAP');
                                await action_blocks.instagram(
                                  context,
                        ...
                        Column(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'T_PADRAO_COMP_mapMarker_ICN_ON_TAP');
