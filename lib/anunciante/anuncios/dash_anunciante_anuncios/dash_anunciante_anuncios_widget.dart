...
import 'dash_anunciante_anuncios_model.dart';
export 'dash_anunciante_anuncios_model.dart';

class DashAnuncianteAnunciosWidget extends StatefulWidget {
  const DashAnuncianteAnunciosWidget({
    super.key,
    this.anuncianteDoc,
  });
  ...
  @override
  State<DashAnuncianteAnunciosWidget> createState() =>
      _DashAnuncianteAnunciosWidgetState();
}

class _DashAnuncianteAnunciosWidgetState
    extends State<DashAnuncianteAnunciosWidget> with TickerProviderStateMixin {
  late DashAnuncianteAnunciosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashAnuncianteAnunciosModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'DashAnuncianteAnuncios'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('DASH_ANUNCIANTE_ANUNCIOS_DashAnuncianteA');
      if (widget.anuncianteDoc?.formatoAnuncio != null &&
          widget.anuncianteDoc?.formatoAnuncio != '') {
        setState(() {
          _model.tabBar = widget.anuncianteDoc?.formatoAnuncio;
        });
      } else {
        setState(() {
          _model.tabBar = 'Imagens';
        });
      }
    });
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AnunciosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AnunciosRecord> dashAnuncianteAnunciosAnunciosRecordList =
            snapshot.data!;
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: MediaQuery.sizeOf(context).width <= 479.0
                ? PreferredSize(
                          ...
                          children: [
                            Align(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'DASH_ANUNCIANTE_ANUNCIOS_Icon_z54yjy5c_O');
                                                        ...
                                                        child:
                                                          ...
                                                          onChanged:
                                                            ...
                                                            setState(() => _model
                                                                ...
                                                                val);
                                                            logFirebaseEvent(
                                                                'DASH_ANUNCIANTE_ANUNCIOS_DropDown_oeh3hj');
                                                            ScaffoldMessenger
                                                                    .of(context)
                                                                .showSnackBar(
                                                              SnackBar(
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'DASH_ANUNCIANTE_ANUNCIOS_Column_khgpbsff');
                                                          setState(() {
                                                            _model.tabBar =
                                                                'Imagens';
                                                          });
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'DASH_ANUNCIANTE_ANUNCIOS_Column_4vbyzjyj');
                                                              setState(() {
                                                                _model.tabBar =
                                                                    'Produtos';
                                                              });
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              widget.anuncianteDoc?.formatoAnuncio == 'Imagem' ? 'AO VIVO' : 'Em espera',
                                                              ...
                                                              Container(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'DASH_ANUNCIANTE_ANUNCIOS_ANUNCIO_BTN_ON_');
                                                                    if (((widget.anuncianteDoc?.planoAssinatura !=
                                                                                'gratis') &&
                                                                            (dashAnuncianteAnunciosAnunciosRecordList.where((e) => e.isCapaCategoria == false).toList().length <
                                                                                4)) ||
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: NewAnuncioListaDeImgnsWidget(
                                                                                  ...
                                                                                  iscapa: widget.anuncianteDoc?.planoAssinatura == 'medestacaCapa',
                                                                                ),
                                                                              ),
                                                                            ),
                                                                          );
                                                                  ...
                                                                  text: widget.anuncianteDoc
                                                                              ?.planoAssinatura ==
                                                                          'medestacaCapa'
                                                                      ? 'Imagem da Capa'
                                                                      : 'Adicionar imagem ${valueOrDefault<String>(
                                                                          dashAnuncianteAnunciosAnunciosRecordList
                                                                              .where((e) => e.isCapaCategoria == false)
                                                                              .toList()
                                                                              .length
                                                                              .toString(),
                                                                          '0',
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Builder(
                                                              builder:
                                                                  (context) {
                                                                final listaDeAnuncios = dashAnuncianteAnunciosAnunciosRecordList
                                                                    .where((e) =>
                                                                        e.isCapaCategoria ==
                                                                        false)
                                                                    .toList()
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Flexible(
                                                                                    child: InkWell(
                                                                                      ...
                                                                                      highlightColor: Colors.transparent,
                                                                                      onTap: () async {
                                                                                        logFirebaseEvent('DASH_ANUNCIANTE_ANUNCIOS_Container_7jvqr');
                                                                                      ...
                                                                                      Align(
                                                                                        ...
                                                                                        child: Padding(
                                                                                          ...
                                                                                          child: InkWell(
                                                                                            ...
                                                                                            highlightColor: Colors.transparent,
                                                                                            onTap: () async {
                                                                                              logFirebaseEvent('DASH_ANUNCIANTE_ANUNCIOS_Icon_op69mzsy_O');
                                                                                              var confirmDialogResponse = await showDialog<bool>(
                                                                                                    context: context,
                                                                                                    builder: (alertDialogContext) {
                                                                                                      return WebViewAware(
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children:
                                                                              ...
                                                                              if (widget.anuncianteDoc?.planoAssinatura == 'gratis')
                                                                                Row(
                                                                                  mainAxisSize: MainAxisSize.max,
                                                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                                                  children: [
                                                                                    if (widget.anuncianteDoc?.planoAssinatura != 'gratis')
                                                                                      wrapWithModel(
                                                                                        ...
                                                                                        child: EstrelaBloqueioWidget(
                                                                                          planoAssinatura: widget.anuncianteDoc!.planoAssinatura,
                                                                                          tamanho: 24,
                                                                                        ),
                                                                                      ),
                                                                                    Text(
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder: (context) =>
                                                                                FFButtonWidget(
                                                                              onPressed: () async {
                                                                                logFirebaseEvent('DASH_ANUNCIANTE_ANUNCIOS_ANUNCIO_BTN_ON_');
                                                                                if (widget.anuncianteDoc?.planoAssinatura != 'gratis') {
                                                                                  await showModalBottomSheet(
                                                                              ...
                                                                              text: 'Selecionar produtos  ${valueOrDefault<String>(
                                                                                dashAnuncianteAnunciosAnunciosRecordList.length.toString(),
                                                                                '0',
                                                                              )} / 4',
                                                                              icon: Icon(
                                                                                Icons.add,
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return ListView
                                                                            ...
                                                                            itemBuilder:
                                                                              ...
                                                                              final listViewProdutoRecord = listViewProdutoRecordList[listViewIndex];
                                                                              return Material(
                                                                                color: Colors.transparent,
                                                                                elevation: 1.0,
