                  ...
                  child: Column(
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'NEW_ANUNCIO_LISTA_DE_IMGNS_Divider_9fbkh');
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'NEW_ANUNCIO_LISTA_DE_IMGNS_Image_ON_TAP');
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: _model.isDataUploading
                                ...
                                : () async {
                                    logFirebaseEvent(
                                        'NEW_ANUNCIO_LISTA_DE_IMGNS_SALVAR_BTN_ON');
                                    if (_model.uploadedFileUrl != null &&
                                        _model.uploadedFileUrl != '') {
                                      await AnunciosRecord.createDoc(widget
                                              .adicionarAnuncio!.reference)
                                          .set(createAnunciosRecordData(
                                        fotoAnuncio: _model.imgAnuncio,
                                        anunciado: true,
                                        categoria:
                                            widget.adicionarAnuncio?.categoria,
                                        planoDoAnuncio: widget
                                            .adicionarAnuncio?.planoAssinatura,
