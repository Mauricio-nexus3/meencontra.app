...
import 'dashboard_n_w_suporte_model.dart';
export 'dashboard_n_w_suporte_model.dart';

class DashboardNWSuporteWidget extends StatefulWidget {
  const DashboardNWSuporteWidget({
    super.key,
    this.anuncianteDoc,
  });
  ...
  @override
  State<DashboardNWSuporteWidget> createState() =>
      _DashboardNWSuporteWidgetState();
}

class _DashboardNWSuporteWidgetState extends State<DashboardNWSuporteWidget>
    with TickerProviderStateMixin {
  late DashboardNWSuporteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardNWSuporteModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<AnunciosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AnunciosRecord> dashboardNWSuporteAnunciosRecordList =
            snapshot.data!;
