...
import 'sub_ctegoria_copy2_model.dart';
export 'sub_ctegoria_copy2_model.dart';

class SubCtegoriaCopy2Widget extends StatefulWidget {
  const SubCtegoriaCopy2Widget({
    super.key,
    this.subCategoriaRefExcluir,
    required this.categoriaDoc,
  });

  final DocumentReference? subCategoriaRefExcluir;
  final CategoriasRecord? categoriaDoc;

  @override
  State<SubCtegoriaCopy2Widget> createState() => _SubCtegoriaCopy2WidgetState();
}

class _SubCtegoriaCopy2WidgetState extends State<SubCtegoriaCopy2Widget> {
  late SubCtegoriaCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubCtegoriaCopy2Model());
                ...
                child: StreamBuilder<List<AnunciosRecord>>(
                  stream: queryAnunciosRecord(
                    queryBuilder: (anunciosRecord) => anunciosRecord.where(
                      'Categoria',
                      isEqualTo: widget.categoriaDoc?.nomeDaCategoria,
                    ),
                  ),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                                                              ...
                                                              child: Hero(
                                                                ...
                                                                child: Material(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    key: Key(
                                                                        'Keyl2u_${medestacaCapaIndex}_of_${medestacaCapa.length}'),
                                                                    fotoDestaquePremium:
                                                                        medestacaCapaItem
                                                                            .fotoAnuncio,
                                                                    discricao:
