...
import 'selecinar_capa_model.dart';
export 'selecinar_capa_model.dart';

class SelecinarCapaWidget extends StatefulWidget {
  const SelecinarCapaWidget({
    super.key,
  ...
  @override
  State<SelecinarCapaWidget> createState() => _SelecinarCapaWidgetState();
}

class _SelecinarCapaWidgetState extends State<SelecinarCapaWidget>
    with TickerProviderStateMixin {
  late SelecinarCapaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelecinarCapaModel());
