...
import 'card_premium_categoria_copy_model.dart';
export 'card_premium_categoria_copy_model.dart';

class CardPremiumCategoriaCopyWidget extends StatefulWidget {
  const CardPremiumCategoriaCopyWidget({
    super.key,
  ...
  @override
  State<CardPremiumCategoriaCopyWidget> createState() =>
      _CardPremiumCategoriaCopyWidgetState();
}

class _CardPremiumCategoriaCopyWidgetState
    extends State<CardPremiumCategoriaCopyWidget> {
  late CardPremiumCategoriaCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CardPremiumCategoriaCopyModel());
            ...
            return StreamBuilder<List<ProdutoRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                final containerProdutoRecord =
                    containerProdutoRecordList.isNotEmpty
                        ? containerProdutoRecordList.first
                        : null;
                return Container(
                  decoration: BoxDecoration(),
                  child: Stack(
                    children: [
                      ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl:
                              containerProdutoRecord!.imagensProduto.first,
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          fadeInDuration: Duration(milliseconds: 500),
                          fadeOutDuration: Duration(milliseconds: 500),
                          imageUrl: containerAnunciosRecord!.fotoAnuncio,
                          width: double.infinity,
                          height: double.infinity,
                          fit: BoxFit.cover,
                        ),
