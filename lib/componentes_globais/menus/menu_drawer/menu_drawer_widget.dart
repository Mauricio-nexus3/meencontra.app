                                ...
                                children: [
                                  Icon(
                                    ...
                                    color: valueOrDefault<Color>(
                                      widget!.paginaAtual ==
                                              TelasMenuDrawer.dashboard_me.name
                                          ? _model.pageON
                                          : _model.pageOff,
                      ...
                      children: [
                        ...
                        if (responsiveVisibility(
                          ...
                          MouseRegion(
                            ...
                            onExit: ((event) async {
                              safeSetState(() =>
                                  _model.mouseRegionMecontrataHovered = false);
                            }),
                          ),
                        if (responsiveVisibility(
                          context: context,
                    ...
                    if (valueOrDefault(currentUserDocument?.perfil, '') ==
                      ...
                      AuthUserStreamWidget(
                        builder: (context) => MouseRegion(
                          ...
                          onEnter: ((event) async {
                            safeSetState(() =>
                                _model.mouseRCadastrarMeuNegocioHovered = true);
                          }),
                          onExit: ((event) async {
                            safeSetState(() => _model
                        ...
                        builder: (context) =>
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<AnuncianteRecord>
                                containerAnuncianteRecordList = snapshot.data!;
                              ...
                              child: Column(
                                ...
                                children: [
                                  MouseRegion(
                                    ...
                                    onEnter: ((event) async {
                                      safeSetState(() => _model
                                          .mouseRegionMeuNegocioHovered = true);
                                    }),
                                    onExit: ((event) async {
                                      safeSetState(() =>
                                          _model.mouseRegionMeuNegocioHovered =
                                              false);
                                    }),
                                  ),
                                  MouseRegion(
                                    ...
                                    onEnter: ((event) async {
                                      safeSetState(() => _model
                                          .mouseRegionPainelAdmHovered = true);
                                    }),
                                    onExit: ((event) async {
                                      safeSetState(() => _model
                                          .mouseRegionPainelAdmHovered = false);
                                    }),
                                  ),
                                  MouseRegion(
                                    opaque: false,
                                    ...
                                    onExit: ((event) async {
                                      safeSetState(() => _model
                                          .mouseRegionCatalogoHovered = false);
                                    }),
                                  ),
                                  MouseRegion(
                                    opaque: false,
