        ...
        child: Column(
          ...
          children: [
            InkWell(
              ...
              onTap: () async {
                logFirebaseEvent('ADICIONAR_HORARIO_Divider_lr4w7oz8_ON_TA');
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'ADICIONAR_HORARIO_HORARIO_DE_ABERTURA_BT');
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'ADICIONAR_HORARIO_HORARIO_DE_FECHAMENTO_');
            ...
            FFButtonWidget(
              onPressed: () async {
                logFirebaseEvent('ADICIONAR_HORARIO_CADASTRAR_BTN_ON_TAP');
