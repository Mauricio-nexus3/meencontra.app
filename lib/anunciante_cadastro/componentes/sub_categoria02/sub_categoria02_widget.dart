...
import 'sub_categoria02_model.dart';
export 'sub_categoria02_model.dart';

class SubCategoria02Widget extends StatefulWidget {
  const SubCategoria02Widget({
    super.key,
  ...
  @override
  State<SubCategoria02Widget> createState() => _SubCategoria02WidgetState();
}

class _SubCategoria02WidgetState extends State<SubCategoria02Widget>
    with TickerProviderStateMixin {
  late SubCategoria02Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubCategoria02Model());
                  ...
                  child: Row(
                    ...
                    children: [
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'SUB_CATEGORIA02_close_rounded_ICN_ON_TAP');
                  ...
                  child: Column(
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'SUB_CATEGORIA02_Divider_sm720140_ON_TAP');
                          Navigator.pop(context);
                        },
                        child: SizedBox(
                          width: 40.0,
                              ...
                              child: StreamBuilder<List<SubCategoriasRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<SubCategoriasRecord>
                                      subCatg02SubCategoriasRecordList =
                                      snapshot.data!;
                                  return FlutterFlowDropDown<String>(
                                    ...
                                    options: subCatg02SubCategoriasRecordList
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'SUB_CATEGORIA02_ATUALIZAR_BTN_ON_TAP');
                                  ...
                                  Align(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'SUB_CATEGORIA02_COMP_CANCELAR_BTN_ON_TAP');
