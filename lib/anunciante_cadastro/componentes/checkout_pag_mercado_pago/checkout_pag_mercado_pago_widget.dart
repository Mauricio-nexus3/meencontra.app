...
import 'checkout_pag_mercado_pago_model.dart';
export 'checkout_pag_mercado_pago_model.dart';

class CheckoutPagMercadoPagoWidget extends StatefulWidget {
  const CheckoutPagMercadoPagoWidget({super.key});

  @override
  State<CheckoutPagMercadoPagoWidget> createState() =>
      _CheckoutPagMercadoPagoWidgetState();
}

class _CheckoutPagMercadoPagoWidgetState
    extends State<CheckoutPagMercadoPagoWidget> {
  late CheckoutPagMercadoPagoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CheckoutPagMercadoPagoModel());

    _model.numeroTextController ??= TextEditingController();
    _model.numeroFocusNode ??= FocusNode();

    _model.mesAnoTextController ??= TextEditingController();
    _model.mesAnoFocusNode ??= FocusNode();
                          ...
                          Flexible(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  8.0, 0.0, 8.0, 0.0),
                              child: TextFormField(
                                controller: _model.mesAnoTextController,
                                focusNode: _model.mesAnoFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                ...
                                validator: _model.mesAnoTextControllerValidator
                                    .asValidator(context),
                                inputFormatters: [_model.mesAnoMask],
                              ),
                            ),
                          ),
                          Expanded(
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Documento do titular',
                            labelStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  fontFamily: 'Inter',
