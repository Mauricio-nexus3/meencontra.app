                  ...
                  child: Row(
                    ...
                    children: [
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'WHATSAPP_COMP_close_rounded_ICN_ON_TAP');
                  ...
                  child: Column(
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'WHATSAPP_COMP_Divider_na2aaaii_ON_TAP');
                          Navigator.pop(context);
                        },
                        child: SizedBox(
                          width: 40.0,
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'WHATSAPP_COMP_Divider_p1dkuxwt_ON_TAP');
                          Navigator.pop(context);
                        },
                        child: Divider(
                          thickness: 1.0,
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'WHATSAPP_COMP_ATUALIZAR_BTN_ON_TAP');
                                  ...
                                  Align(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'WHATSAPP_COMP_CANCELAR_BTN_ON_TAP');
                                        Navigator.pop(context);
                                      },
                                      text: 'Cancelar',
                                      options: FFButtonOptions(
