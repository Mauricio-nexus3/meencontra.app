...
class _BloqueioWidgetState extends State<BloqueioWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Bloqueio'});
                          ...
                          Column(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'BLOQUEIO_PAGE_Container_y960gu5w_ON_TAP');
                                  ...
                                  context.pushNamed(
                                    ...
                                    queryParameters: {
                                      ...
                                      'nomeFantasia': serializeParam(
                                        bloqueioAnuncianteRecord.nomeFantasia,
                                        ParamType.String,
                                      ),
                                    }.withoutNulls,
                                  );
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'BLOQUEIO_PAGE_Container_0ed9hfqg_ON_TAP');
