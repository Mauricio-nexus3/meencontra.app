...
class _AddRedesocialWidgetState extends State<AddRedesocialWidget> {
  ...
  void initState() {
    ...
    _model.inputSocialController ??= TextEditingController();
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium,
                                            validator: _model
                                                .inputSocialControllerValidator
                                                .asValidator(context),
                                          ),
                                        ),
                                      ),
                      ...
                      onPressed: () async {
                        if (_model.dropDownRdSocialValue != null &&
                          ...
                          await RedeSocialRecord.createDoc(
                            ...
                            arroboDaRedeSocial:
                                _model.inputSocialController.text,
                          ...
                          setState(() {
                            _model.inputSocialController?.clear();
                          });
