...
class CadastroInicialModel extends FlutterFlowModel<CadastroInicialWidget> {
  ...
  TextEditingController? nomeFantasiaObrigatorioController;
  ...
  TextEditingController? whatsComercialController;
  final whatsComercialMask = MaskTextInputFormatter(mask: '###########');
  String? Function(BuildContext, String?)? whatsComercialControllerValidator;
  ...
  void dispose() {
    ...
    nomeFantasiaObrigatorioController?.dispose();

    whatsComercialFocusNode?.dispose();
    whatsComercialController?.dispose();
