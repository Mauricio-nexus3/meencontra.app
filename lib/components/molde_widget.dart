...
import 'molde_model.dart';
export 'molde_model.dart';

class MoldeWidget extends StatefulWidget {
  const MoldeWidget({
    super.key,
  ...
  @override
  State<MoldeWidget> createState() => _MoldeWidgetState();
}

class _MoldeWidgetState extends State<MoldeWidget>
    with TickerProviderStateMixin {
  late MoldeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MoldeModel());
