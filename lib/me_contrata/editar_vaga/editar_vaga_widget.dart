...
import 'editar_vaga_model.dart';
export 'editar_vaga_model.dart';

class EditarVagaWidget extends StatefulWidget {
  const EditarVagaWidget({
    super.key,
    required this.editarVaga,
  });

  final DocumentReference? editarVaga;

  @override
  State<EditarVagaWidget> createState() => _EditarVagaWidgetState();
}

class _EditarVagaWidgetState extends State<EditarVagaWidget> {
  late EditarVagaModel _model;
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<MeContrataVAGASRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final editarVagaMeContrataVAGASRecord = snapshot.data!;
