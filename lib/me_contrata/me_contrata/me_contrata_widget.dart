                ...
                child: Scaffold(
                  ...
                  floatingActionButton: Padding(
                    ...
                    child: FloatingActionButton(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ME_CONTRATA_FloatingActionButton_he7mkvi');
                    ...
                    child: WebViewAware(
                      child: wrapWithModel(
                        ...
                        child: MenuDrawerWidget(
                          paginaAtual: TelasMenuDrawer.mecontrata.name,
                        ),
                      ),
                    ),
                  ),
                              ...
                              Container(
                                ...
                                child: wrapWithModel(
                                  ...
                                  child: MenuHorizontalWidget(
                                    paginaAtual:
                                        TelasMenuDrawer.mecontrata.name,
                                    drawerAcao: () async {
                                      logFirebaseEvent(
                                          'ME_CONTRATA_Container_q1yhlzkm_CALLBACK');
                                                        ...
                                                        children: [
                                                          FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'ME_CONTRATA_PUBLIQUE_DE_GRAA_BTN_ON_TAP');
                                              ...
                                              if (responsiveVisibility(
                                                ...
                                                Container(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'ME_CONTRATA_PAGE_Row_zvdgic7u_ON_TAP');
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children:
                                                                            ...
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                Container(
                                                                                  ...
                                                                                  child: Image.network(
                                                                                    gridDesktopItem.logoEmpresa,
                                                                                    fit: BoxFit.cover,
                                                                                  ),
                                                                                ),
                                                                                Flexible(
                                                                                  child: Text(
                                                                                    gridDesktopItem.nomeEmpresa,
                                                                        ...
                                                                        FFButtonWidget(
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('ME_CONTRATA_VISUALIZAR_VAGA_BTN_ON_TAP');
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    wrapWithModel(
                                      ...
                                      updateCallback: () => safeSetState(() {}),
                                      child: NavbarWidget(
                                        paginaAtual: TelasMenuDrawer.mecontrata,
                                      ),
                                    ),
                                  ],
                                ),
