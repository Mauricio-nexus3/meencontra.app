              ...
              title: AuthUserStreamWidget(
                builder: (context) => wrapWithModel(
                  ...
                  child: AppbarGrupoMeWidget(
                    ...
                    searchImg: widget.eventoRef?.imagemCapa,
                    searchTitle: widget.eventoRef?.nomeEvento,
                    searchDescription: widget.eventoRef?.sobre,
                    searchTitlePage: 'medivirta',
                    iconLeft: () async {
                      logFirebaseEvent(
                          'ME_DIVIRTI_DETALHES_EVENTO_Container_glr');
                      context.safePop();
                    },
                    iconRight: () async {
                      logFirebaseEvent(
                            ...
                            child: Row(
                              ...
                              children: [
                                FFButtonWidget(
                                  ...
                                  text: widget.eventoRef?.notificacaoEnviada ==
                                          false
                                      ? 'Enviar notificação'
                                      : 'Notificação enviada',
                                  icon: FaIcon(
                                ...
                                Flexible(
                                  child: Text(
                                    'Total de visualizações: ${formatNumber(
                                      widget.eventoRef?.numeroVisualizacoes,
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  if (widget.eventoRef?.ingressoURL != null &&
                                      widget.eventoRef?.ingressoURL != '')
                                    InkWell(
                                  ...
                                  if (widget.eventoRef?.localizacaoGoogleMaps !=
                                      null)
                                    InkWell(
                                      splashColor: Colors.transparent,
                                      focusColor: Colors.transparent,
