                ...
                AuthUserStreamWidget(
                  builder: (context) => wrapWithModel(
                    ...
                    child: AppbarGrupoMeWidget(
                      ...
                      iconLeft: () async {
                        logFirebaseEvent(
                            'CRIAR_NOVO_EVENTO_Container_ormvkd46_CAL');
                        context.safePop();
                      },
                      iconRight: () async {
                        logFirebaseEvent(
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      children: [
                                        if (_model.switchIngressoValue == true)
                                          Material(
                                            color: Colors.transparent,
                                            elevation: 3.0,
                                            shape: RoundedRectangleBorder(
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'CRIAR_NOVO_EVENTO_PAGE_btn_ON_TAP');
                                              ...
                                              children: [
                                                ...
                                                Align(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'CRIAR_NOVO_EVENTO_PAGE_Proximo_ON_TAP');
                                                      setState(() {
