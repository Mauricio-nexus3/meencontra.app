...
class _MeDashboardAnunciantesWidgetState
  ...
  void initState() {
    ...
    _model.lupaController ??= TextEditingController();
                                                          ...
                                                          return ListView
                                                            ...
                                                            itemBuilder: (context,
                                                              ...
                                                              final tableAnunciantesAlgoliaItem =
                                                                  tableAnunciantesAlgolia[
                                                                      tableAnunciantesAlgoliaIndex];
                                                              return CardTabelaAnuncianteWidget(
                                                                key: Key(
                                                                    'Keyj4h_${tableAnunciantesAlgoliaIndex}_of_${tableAnunciantesAlgolia.length}'),
                                                                anuncianteRef:
                                                        ...
                                                        builder: (context) {
                                                          ...
                                                          return ListView
                                                            ...
                                                            itemBuilder: (context,
                                                              ...
                                                              return CardTabelaAnuncianteWidget(
                                                                key: Key(
                                                                    'Keytc7_${tableAnunciantesIndex}_of_${tableAnunciantes.length}'),
                                                                anuncianteRef:
