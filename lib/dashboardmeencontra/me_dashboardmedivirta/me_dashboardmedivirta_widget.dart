...
import '/dashboardmeencontra/componentes/card_tabelamedivirta/card_tabelamedivirta_widget.dart';
                                                    ...
                                                    return ListView.separated(
                                                      ...
                                                      itemBuilder: (context,
                                                        ...
                                                        final tablevagasItem =
                                                            tablevagas[
                                                                tablevagasIndex];
                                                        return CardTabelamedivirtaWidget(
                                                          key: Key(
                                                              'Keyzpf_${tablevagasIndex}_of_${tablevagas.length}'),
                                                          localidade:
                                                              tablevagasItem
                                                                  .local,
                                                          imgCapa:
