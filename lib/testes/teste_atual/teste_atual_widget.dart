                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          _model.kkkkk = await queryCategoriasRecordOnce(
                          ...
                          context.pushNamed(
                            'SubCtegoriaCopy2',
                            queryParameters: {
                              'categoriaDoc': serializeParam(
                                _model.kkkkk,
                                ParamType.Document,
                              ),
                            }.withoutNulls,
                            extra: <String, dynamic>{
                              'categoriaDoc': _model.kkkkk,
                            },
                          );
                    ...
                    Builder(
                      builder: (context) {
                        final testeAtualVar = testeAtualAnuncianteRecordList
                            .where((e) =>
                                e.templeteLayout != null &&
                                e.templeteLayout != '')
                            .toList();
                        return ListView.builder(
                          ...
                          itemBuilder: (context, testeAtualVarIndex) {
                            final testeAtualVarItem =
                                testeAtualVar[testeAtualVarIndex];
                            return Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 1.0),
                              child: InkWell(
                    ...
                    Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final testeAtualVar = testeAtualAnuncianteRecordList
                              .where(
                                  (e) => e.nomeFantasia == ' Agência Nexus 3')
                              .toList()
                              .take(2)
                              .toList();
                          return ListView.builder(
