...
import 'me_dashboardmecontrata_model.dart';
export 'me_dashboardmecontrata_model.dart';

class MeDashboardmecontrataWidget extends StatefulWidget {
  const MeDashboardmecontrataWidget({super.key});

  @override
  State<MeDashboardmecontrataWidget> createState() =>
      _MeDashboardmecontrataWidgetState();
}

class _MeDashboardmecontrataWidgetState
    extends State<MeDashboardmecontrataWidget> {
  late MeDashboardmecontrataModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeDashboardmecontrataModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'meDashboardmecontrata'});
    ...
    return StreamBuilder<List<MeContrataVAGASRecord>>(
      stream: queryMeContrataVAGASRecord(
        queryBuilder: (meContrataVAGASRecord) =>
            meContrataVAGASRecord.orderBy('Publicado', descending: true),
      ),
      builder: (context, snapshot) {
        ...
        List<MeContrataVAGASRecord>
            meDashboardmecontrataMeContrataVAGASRecordList = snapshot.data!;
                ...
                if (MediaQuery.sizeOf(context).width <= 480.0)
                  SliverAppBar(
                    ...
                    leading: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'ME_DASHBOARDMECONTRATA_menuAnunciante_IC');
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'ME_DASHBOARDMECONTRATA_NOVA_VAGA_BTN_ON_');

                                            context.pushNamed('CriarNovaVaga');
                                          },
                                          text: 'Nova vaga',
                                          icon: Icon(
                                            Icons.add_rounded,
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    padding: EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                    child: Text(
                                                                      meDashboardmecontrataMeContrataVAGASRecordList
                                                                          .length
                                                                          .toString(),
                                                      ...
                                                      itemBuilder: (context,
                                                        ...
                                                        return Builder(
                                                          builder: (context) =>
                                                            ...
                                                            key: Key(
                                                                'Keyytb_${tablevagasIndex}_of_${tablevagas.length}'),
                                                            col01Imagem:
                                                                tablevagasItem
                                                                    .logoEmpresa,
                                                            ...
                                                            irParaAuncianteRef:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'ME_DASHBOARDMECONTRATA_Container_ytbixj8');
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          excluir:
                                                                            ...
                                                                            if (confirmDialogResponse) {
                                                                              await FirebaseStorage.instance.refFromURL(tablevagasItem.logoEmpresa).delete();
