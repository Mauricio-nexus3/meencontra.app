...
import 'me_dashboardmeinforma_model.dart';
export 'me_dashboardmeinforma_model.dart';

class MeDashboardmeinformaWidget extends StatefulWidget {
  const MeDashboardmeinformaWidget({super.key});

  @override
  State<MeDashboardmeinformaWidget> createState() =>
      _MeDashboardmeinformaWidgetState();
}

class _MeDashboardmeinformaWidgetState
    extends State<MeDashboardmeinformaWidget> {
  late MeDashboardmeinformaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeDashboardmeinformaModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'meDashboardmeinforma'});
                ...
                if (MediaQuery.sizeOf(context).width <= 480.0)
                  SliverAppBar(
                    ...
                    leading: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'ME_DASHBOARDMEINFORMA_menuAnunciante_ICN');
                        ...
                        child: Align(
                          ...
                          child: StreamBuilder<List<MateriasRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<MateriasRecord> maxWidthMateriasRecordList =
                                  snapshot.data!;
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'ME_DASHBOARDMEINFORMA_NOVA_MATERIA_BTN_O');
                                                _model.tvgo =
                                                    await queryMeInformaRecordOnce(
                                                  singleRecord: true,
                                                                          ...
                                                                          children: [
                                                                            Builder(
                                                                              builder: (context) => FlutterFlowIconButton(
                                                                                ...
                                                                                onPressed: () async {
                                                                                  logFirebaseEvent('ME_DASHBOARDMEINFORMA_more_vert_ICN_ON_T');
                                                                                          ...
                                                                                          child: GestureDetector(
                                                                                            ...
                                                                                            child: Padding(
                                                                                              ...
                                                                                              child: AcaoTabaleWidget(
                                                                                                ...
                                                                                                enviarNotificacao: () async {
                                                                                                  _model.contultaUsuariosRef = await queryUsersRecordOnce();
                                                                                                  triggerPushNotification(
                                                                                                    notificationTitle: 'meinforma',
                                                                                                    notificationText: tabelaMeinformaItem.tituloMateria,
                                                                                                    notificationImageUrl: 'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/meencontra-gflgrp/assets/il24hbpde2nh/informame.png',
                                                                                                    notificationSound: 'default',
                                                                                                    userRefs: _model.contultaUsuariosRef!.map((e) => e.reference).toList(),
                                                                                                    initialPageName: 'meinformaDetalhesNoticia',
                                                                                                    parameterData: {
                                                                                                      'materiadoc': tabelaMeinformaItem,
                                                                                                    },
                                                                                                  );

                                                                                                  await tabelaMeinformaItem.reference.update(createMateriasRecordData(
