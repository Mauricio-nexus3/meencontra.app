...
import 'me_dashboard_model.dart';
export 'me_dashboard_model.dart';

class MeDashboardWidget extends StatefulWidget {
  const MeDashboardWidget({super.key});

  @override
  State<MeDashboardWidget> createState() => _MeDashboardWidgetState();
}

class _MeDashboardWidgetState extends State<MeDashboardWidget>
    with TickerProviderStateMixin {
  late MeDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeDashboardModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'meDashboard'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ME_DASHBOARD_meDashboard_ON_INIT_STATE');
      _model.queryAnunciantes = await queryAnuncianteRecordCount();
      _model.queryMaterias = await queryMateriasRecordCount();
      _model.querymecontrata = await queryMeContrataVAGASRecordCount();
      _model.querymedivirta = await queryMeDiverteRecordCount();
      _model.querysuporte = await queryTicketSuporteRecordCount();
    });
                ...
                if (MediaQuery.sizeOf(context).width <= 480.0)
                  SliverAppBar(
                    ...
                    leading: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'ME_DASHBOARD_menuAnunciante_ICN_ON_TAP');
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  '*Esses dados atualmente são fictícios',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .headlineLarge
                                                      .override(
                                                                    ...
                                                                    Flexible(
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            _model.querymecontrata?.toString(),
                                                                            '0',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .displaySmall
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          text:
                                                                            ...
                                                                            children: [
                                                                              TextSpan(
                                                                                text: 'Investimento em marketing ',
                                                                                style: TextStyle(),
                                                                              ),
                                                                              TextSpan(
                                                                                text: 'R\$302,00',
